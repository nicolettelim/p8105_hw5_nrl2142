...
From the plot, it seems that as group size increases, the probability of
at least one shared birthday also increases. However, the rate of
increase begins to plateau around group size \>50 as the probability
approaches 1.
...
overestimation of muhat. However, when true mu \>3, the test has enough
